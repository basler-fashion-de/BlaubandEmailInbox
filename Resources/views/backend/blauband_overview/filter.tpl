<div class="cta-row">
    <div class="two-cols">
        ...
        <select id="relationshipSelect" name="relationshipSelect" class="filter-input">
            ...
            <option {if $relationshipSelect == 'both'}selected
                    {/if}value="both">{s namespace="blauband/mail" name="bothRelationship"}{/s}</option>
    ...
    <div class="two-cols">
        ...
        <div class="checkbox-wrapper">
            <input class="filter-input" type="checkbox" id="stateDone" name="stateDone"{if $stateDone} checked{/if}>
            <label class="checkbox" for="stateDone">{s namespace="blauband/mail" name="done"}{/s}</label>
